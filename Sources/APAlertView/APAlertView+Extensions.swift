...
extension APAlertView {
    ...
    /// Shows a simple confirmation dialog with custom actions
    /// - Parameters:
    ...
    public func showConfirmationDialog(
        ...
        showConfirmationDialog(configuration)
    }
    
    /// Shows a photo picker confirmation dialog
    /// - Parameters:
    ///   - onCamera: Action to perform when camera is selected
    ///   - onPhotoLibrary: Action to perform when photo library is selected
    ///   - onCancel: Optional action to perform on cancellation
    public func showPhotoPickerConfirmationDialog(
